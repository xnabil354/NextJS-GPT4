  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="A ChatBOT AI for provide 24/7 service to customers without the need for human employees." />
      ...
      <div className={styles.topnav}>
        ...
        <div className={styles.navlinks}>
          ...
          <a href="https://instagram.com/xzhndvs" target="_blank">Instagram</a>
        </div>
      </div>
      <main className={styles.main}>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.footer}>
            <p><a href="https://openai.com/" target="_blank">ChatGPT</a> Mar 14 Version. Free Research Preview. Our goal is to make AI systems more natural and safe to interact with. Your feedback will help us improve. Developer By <a href='https://instagram.com/xzhndvs'>X - ZhnDvs .</a></p>
          </div>
        </div>
      </main>
    </>
